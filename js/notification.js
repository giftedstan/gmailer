...
function limpar() {
    ...
    if (_0x6463xb.length == 0) {
        ...
        notifyMe(
            "We can't clean something that is already clean!",
            "Error clearing list."
        );
        audio2.play();
        return;
        ...
        document.getElementById("demo").innerHTML =
            '<div class="label label-warning label-dismissible">Clean list.</div>';
        audio.play();
        notifyMe(
            "All emails that were on your list have been cleared!",
            "Clean list."
        );
    }
}
...
function start() {
    ...
    if (_0x6463xb.length == 0) {
        document.getElementById("demo").innerHTML =
            '<div class="label label-warning label-dismissible">Load the list</div>';
        notifyMe(
        ...
        document.getElementById("demo").innerHTML =
            '<div class="label label-warning label-dismissible">Initiated.</div>';
        audio.play();
        notifyMe(
            "Your emails have been sent successfully, we're getting started!!",
            "Starting."
        );
    }
    var _0x6463x10;
